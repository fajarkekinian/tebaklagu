...
public class RockScene extends BaseScene implements IOnMenuItemClickListener{

	private LaguAdapter db;
	private Text level1, level2, level3, level4;
	private MenuScene menuChildScene;
	private final String kategori = "rock";
	...
	private void create(){
		...
		rock = new Sprite(0, 0, resourcesManager.regionrockhead, vbom);
		lvl1 = new ScaleMenuItemDecorator(new SpriteMenuItem(no1, resourcesManager.regionrock1, vbom), 1.1f, 1);
		level1 = new Text(0, 0, resourcesManager.helvetica, ""+db.getRockLevelstatus(1)+"/"+db.getRockLevel(1), vbom);
		
		if (db.getRockLevelstatus(1) == db.getRockLevel(1)) {
			lvl2 = new ScaleMenuItemDecorator(new SpriteMenuItem(no2, resourcesManager.regionrock2, vbom), 1.1f, 1);
			level2 = new Text(0, 0, resourcesManager.helvetica, ""+db.getRockLevelstatus(2)+"/"+db.getRockLevel(2), vbom);	
		}else{
		...
		if (db.getRockLevelstatus(2) == db.getRockLevel(2)) {
			lvl3 = new ScaleMenuItemDecorator(new SpriteMenuItem(no3, resourcesManager.regionrock3, vbom), 1.1f, 1);
			level3 = new Text(0, 0, resourcesManager.helvetica, ""+db.getRockLevelstatus(3)+"/"+db.getRockLevel(3), vbom);	
		}else{
		...
		if (db.getRockLevelstatus(3) == db.getRockLevel(3)) {
			lvl4 = new ScaleMenuItemDecorator(new SpriteMenuItem(no4, resourcesManager.regionrock4, vbom), 1.1f, 1);
			level4 = new Text(0, 0, resourcesManager.helvetica, ""+db.getRockLevelstatus(4)+"/"+db.getRockLevel(4), vbom);	
		}else{
